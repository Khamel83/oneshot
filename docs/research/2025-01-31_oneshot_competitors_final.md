...
|---------|--------|---------|
| `/browse` command | ✅ DONE | skills-browser skill created |
| `bd test` framework | ✅ DONE | Added to beads skill |
| diff-preview | ✅ DONE | New skill for change preview |
| skill-analytics | ✅ DONE | Track usage patterns |

**Version bump: 8.1 → 8.2**
- Skills: 43 → 46 (+3 new skills)
- Core skills: 20 → 21 (+1 skills-browser)
- New skills: skills-browser, diff-preview, skill-analytics
...
*Updated:* 2025-01-31 - Phase 1 Quick Wins Implemented
