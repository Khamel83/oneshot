...
echo "  /debug     Systematic debugging (4-phase)"
echo "  /tdd       Test-driven development (RED-GREEN-REFACT)"
echo "  /humanizer Remove AI-generated writing signs"
echo "  /vision    Visual analysis of websites/images"
echo "  /secrets   Manage encrypted secrets"
echo ""
