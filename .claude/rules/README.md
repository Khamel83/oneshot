...
- **web.md** - Web app rules (Vercel + Supabase + Python)
...
|-----------|--------------|--------------|
| `vercel.json` or `supabase/` directory | Web app | core + khamel-mode + web |
...
If this is a **web app** (Vercel + Supabase): Use web defaults
