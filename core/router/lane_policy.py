...
from core.task_schema import LANE_ASSIGNMENTS, TaskClass
...
def resolve(task_class: str, config_path: Optional[str] = None) -> dict:
    """Resolve a task class to a full routing directive.

    Returns JSON-serializable dict with lane, workers, reviewer, search, fallback.
