...
def generate_onboarding(project_dir: Optional[str] = None) -> dict:
    ...
    # Prepend pending tasks (imperative, not informational)
    pending_block = ""
    tasks_path = _janitor_dir(project_dir) / "pending-tasks.md"
    ...
    if sources:
        ...
        source_block = ""
    claude_local.write_text(header + pending_block + summary + source_block)
